...
function injectWow() {
  ...
  newWow.className = "textFuck"
  newWow.innerText = "Fuck"
  ...
  if (wows === 10) {
    lengthEl.innerText = "Fuck fuck"
  }

  if (wows === 50) {
    lengthEl.innerText = "fuck fuck fuck"
  }

  if (wows === 100) {
    lengthEl.innerText = "fuck fuck you"
  }
...
function onBodyClick(e) {
  if (e.target.className === "textFuck" && largewows >= 15) {
    rainbowwows++
